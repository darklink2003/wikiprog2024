...
<body>
    <div class="container2">
        ...
        $sql = "SELECT usuario_id, usuario, img_usuario, correo, biografia, rango_id, intentos_fallidos, cuenta_bloqueada FROM usuario WHERE usuario_id = ?";
        ...
        if ($resultado->num_rows == 1) {
            ...
            $img_usuario = htmlspecialchars($fila['img_usuario']);
